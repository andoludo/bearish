...
def upgrade() -> None:
    ...
    op.create_table('financialstracker',
    ...
    with op.batch_alter_table('financialstracker', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_financialstracker_source'), ['source'], unique=False)
        batch_op.create_index(batch_op.f('ix_financialstracker_symbol'), ['symbol'], unique=False)

    op.create_table('pricetracker',
    sa.Column('exchange', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('source', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('symbol', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    ...
    with op.batch_alter_table('pricetracker', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_pricetracker_source'), ['source'], unique=False)
        batch_op.create_index(batch_op.f('ix_pricetracker_symbol'), ['symbol'], unique=False)

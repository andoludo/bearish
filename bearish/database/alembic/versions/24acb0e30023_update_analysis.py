...
def upgrade() -> None:
    ...
    with op.batch_alter_table('analysis', schema=None) as batch_op:
        batch_op.add_column(sa.Column('positive_free_cash_flow', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('growing_operating_cash_flow', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('operating_cash_flow_is_higher_than_net_income', sa.Float(), nullable=True))
        ...
        batch_op.add_column(sa.Column('mean_dividend_payout_ratio', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('max_dividend_payout_ratio', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('min_dividend_payout_ratio', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('positive_net_income', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('positive_operating_income', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('growing_net_income', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('growing_operating_income', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('positive_diluted_eps', sa.Float(), nullable=True))
        ...
        batch_op.add_column(sa.Column('positive_debt_to_equity', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('positive_return_on_assets', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('positive_return_on_equity', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('earning_per_share', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('price_per_earning_ratio', sa.Float(), nullable=True))

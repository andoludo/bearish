...
Revision ID: e9622b6b629e
Revises: 
Create Date: 2024-11-27 21:06:01.193138
...
def upgrade() -> None:
    ...
    sa.Column('accumulated_depreciation_amortization_ppe', sa.Float(), nullable=True),
    ...
    sa.Column('cash_and_cash_equivalents_at_carrying_value', sa.Float(), nullable=True),
    sa.PrimaryKeyConstraint('date', 'symbol', 'source')
    )
    with op.batch_alter_table('balancesheet', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_balancesheet_date'), ['date'], unique=False)
        batch_op.create_index(batch_op.f('ix_balancesheet_source'), ['source'], unique=False)
        batch_op.create_index(batch_op.f('ix_balancesheet_symbol'), ['symbol'], unique=False)

    op.create_table('basebearishtabletest',
    sa.Column('symbol', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('source', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    with op.batch_alter_table('basebearishtabletest', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_basebearishtabletest_source'), ['source'], unique=False)
        batch_op.create_index(batch_op.f('ix_basebearishtabletest_symbol'), ['symbol'], unique=False)
    ...
    with op.batch_alter_table('cashflow', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_cashflow_source'), ['source'], unique=False)
        batch_op.create_index(batch_op.f('ix_cashflow_symbol'), ['symbol'], unique=False)
    ...
    with op.batch_alter_table('crypto', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_crypto_cryptocurrency'), ['cryptocurrency'], unique=False)
    ...
    with op.batch_alter_table('currency', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_currency_base_currency'), ['base_currency'], unique=False)
        batch_op.create_index(batch_op.f('ix_currency_source'), ['source'], unique=False)
        batch_op.create_index(batch_op.f('ix_currency_symbol'), ['symbol'], unique=False)
    ...
    op.create_table('financialmetrics',
    sa.Column('date', sa.DateTime(), nullable=False),
    sa.Column('created_at', sa.Date(), nullable=False),
    sa.Column('symbol', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('source', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    with op.batch_alter_table('financialmetrics', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_financialmetrics_date'), ['date'], unique=False)
        batch_op.create_index(batch_op.f('ix_financialmetrics_source'), ['source'], unique=False)
        batch_op.create_index(batch_op.f('ix_financialmetrics_symbol'), ['symbol'], unique=False)
